...
import {Container, Content, Background} from './styles.css';
...
import { Navbar, Nav, Carousel, CardDeck, Card, Button, Row, Col, Image } from 'react-bootstrap';
            ...
            <Navbar bg="light" expand="lg">
                ...
                <Navbar.Collapse id="basic-navbar-nav nav-container">
                    <Nav className="mr-auto nav-space">
                      ...
                      <Nav.Link href="/cadastrar">Criar Conta</Nav.Link>
            ...
            <Carousel>
                <Carousel.Item className="carousel-size">
                  ...
                  <Carousel.Caption>
                    ...
                    <p>Compartilhe suas informações com especialistas para continuar seus
                      cuidados de saúde de forma integral  </p>
                  </Carousel.Caption>
                </Carousel.Item>
                <Carousel.Item className="carousel-size">
                    <img
                    ...
                    <Carousel.Caption>
                      ...
                      <p>Autorize o acesso às informações armazenadas com quem
                        você confia e de maneira segura
                      </p>
                    </Carousel.Caption>
                </Carousel.Item>
                <Carousel.Item className="carousel-size">
                  ...
                  <Carousel.Caption>
                    ...
                    <p>Baixe e compartilhe seu histórico médico quando precisar. 
                ...
                <CardDeck className="deck-spacing">
                    <Card className="card-size">
                      ...
                      <Card.Body>
                        ...
                        <Button variant="primary" className="btn-servicos">Saiba mais</Button>
                       </Card.Body>
                    </Card>
                    <Card className="card-size">
                      <Card.Img variant="top" src={computer} />
                ...
                <Card className="text-center footer">
                  <Card.Body>
                    ...
                    <br></br>Sodales augue aenean tellus mattis cras non.
                    </Card.Text>
